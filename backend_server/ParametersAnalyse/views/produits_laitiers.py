...
class TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSLAITIERSViewSet(viewsets.ModelViewSet):
    queryset = TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSLAITIERS.objects.all()
    serializer_class = TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSLAITIERSSerializer
#! ----------------TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSLAITIERS----------------
@method_decorator(login_required(), name='dispatch')
class TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSLAITIERSCreateView(CreateView):
    model = TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSLAITIERS
    template_name = 'moderator/analyses/alimentation_animal/physicochimie/produits_laitiers.html'  # Name of your template for the form
    fields = '__all__'  # Fields to include in the form
    success_url = reverse_lazy('produits_laitiers_list')
...
class TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSLAITIERSUpdateView(UpdateView):
    model = TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSLAITIERS
    template_name = 'moderator/analyses/alimentation_animal/physicochimie/produits_laitiers.html'  # Name of your template
    fields = '__all__'
    success_url = reverse_lazy('produits_laitiers_list')
    def form_valid(self, form):
