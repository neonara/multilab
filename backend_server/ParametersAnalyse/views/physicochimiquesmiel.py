...
class TypeDeviANALYSESPHYSICOCHIMIQUESMIELViewSet(viewsets.ModelViewSet):
    queryset = TypeDeviANALYSESPHYSICOCHIMIQUESMIEL.objects.all()
    serializer_class = TypeDeviANALYSESPHYSICOCHIMIQUESMIELSerializer
