...
class TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSPECHECreateView(CreateView):
    ...
    template_name = 'moderator/analyses/alimentation_animal/physicochimie/produit_peche.html'  # Name of your template for the form
    fields = '__all__'  # Fields to include in the form
    success_url = reverse_lazy('produit_peche_list')
...
class TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSPECHEpdateView(UpdateView):
    model = TypeDeviANALYSESPHYSICOCHIMIQUESPRODUITSPECHE
    template_name = 'moderator/analyses/alimentation_animal/physicochimie/produit_peche.html'  # Name of your template
    fields = '__all__'
    success_url = reverse_lazy('produit_peche_list')
    def form_valid(self, form):
