    ...
    <div className="analyses-container">
      {analysesList.map((analyse) => {
        ...
        const shouldShowElements =
          isCurrentAnalysis && openIndex === analyse.key;
        ...
        return (
          <div
            ...
            className={`analyse-item ${
              openIndex === analyse.key ? "analyse-item-on" : ""
            }`}
          >
            <div
              className="analyse-title"
              onClick={() => toggleFAQ(analyse.key)}
            >
              ...
              <div className="expand-btn">
                ...
                <FiMinus
                  className={`expand-icon-rotate ${
                    openIndex === analyse.key ? "expand-icon-on" : ""
                  }`}
                />
              </div>
            </div>
            <div
              className={`analyse-details ${
                openIndex === analyse.key ? "analyse-details-on" : ""
              }`}
            >
              {shouldShowElements ? (
                isLoading ? (
