  ...
  return (
    <div className="apropos-container">
      ...
      <div className="Accreditation">
        ...
        <p>
          {" "}
          Choisir<span className="dark-background">MULTILAB s.a </span> , c'est
          opter pour l'expertise et la fiabilité d'un laboratoire accrédité,
          capable de réaliser des analyses précises et rapides. Grâce à notre
          présence sur tout le territoire tunisien, nous offrons un service de
          proximité, adapté aux besoins spécifiques de chaque client. Notre
          engagement envers la qualité et la sécurité sanitaire garantit des
          résultats conformes aux normes les plus strictes. Avec une gamme
          étendue de méthodes d'analyse,{" "}
          <span className="dark-background">MULTILAB s.a </span> est votre
          partenaire de confiance pour assurer la sécurité et la qualité de vos
          produits.{" "}
        </p>
      </div>
      <div className="apropos-content">
        ...
        <div className="apropos-body">
          ...
          <div className="par-text">
            <p>
              <span className="dark-background">MULTILAB s.a </span> est votre
              partenaire de confiance pour tous vos besoins en analyses. Notre
              laboratoire ultramoderne et notre équipe d'experts hautement
              qualifiés garantissent des résultats précis et fiables dans les
              meilleurs délais.
            </p>
            <div>
              <p>
                <span className="dark-background">MULTILAB s.a </span> assure :
              </p>
              <div className="icons">
                <FaLock
                  style={{
                    color: "rgb(0, 160, 216, 1)",
                    display: "inline-block",
                    marginRight: "10px",
                  }}
                />{" "}
                La confidentialité des résultats d'analyses.
                <br />
                <FaShield
                  style={{
                    color: "rgb(0, 160, 216, 1)",
      ...
      <div className="apropos-container">
        ...
        <p className="description">
          MULTILAB s.a assure le traitement d'environ 50 000 prélèvements par
          an, dont environ 44 000 échantillons analysés au laboratoire de
          microbiologie et 6 000 échantillons analysés au laboratoire de
          physicochimie, pour plus de 170 types d'essais.
        </p>
        ...
        <div className="research-content">
          <div className="text-content">
            <h2 className="research-title">
              Recherche et Développement MULTILAB
            </h2>
            <p className="research-description">
              L'innovation est au cœur de <strong>MULTILAB s.a</strong>, qui
              investit massivement dans son département Recherche &
              Développement. Composé de plusieurs équipes scientifiques
              spécialisées, ce département est l'un des piliers de notre
              laboratoire. Nos experts développent continuellement de nouvelles
              méthodes d'analyse pour répondre aux besoins évolutifs de nos
              clients et garantir des résultats précis et fiables.
              <br />
      ...
      <div className="Accreditation">
        ...
        <p>
          {" "}
          <span className="dark-background">MULTILAB s.a </span> est fier d'être
          accrédité par le <span className="dark-background">TUNAC </span>{" "}
          depuis 2012 dans les domaines de la microbiologie alimentaire, de la
          microbiologie des eaux et de la
        </p>
        <p>
          physicochimie des aliments. Au fil des années, nous avons élargi notre
          champ d'accréditation, passant de{" "}
          <span className="dark-background">6 à 28 méthodes </span>d'analyse
          accréditées.
        </p>
        <p>
          Cette reconnaissance atteste de notre engagement envers la qualité et
          la fiabilité de nos services, garantissant ainsi la confiance de nos
          clients.
        </p>
      </div>
    </div>
