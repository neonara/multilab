    ...
    <div className="container">
      <div className="textContainer">
        ...
        <p className="paragraph">
          Avec notre approche axée sur la proximité, l'expertise, la réactivité et la fiabilité, nous offrons les solutions les plus fiables, innovantes et respectueuses de l'environnement pour garantir une expertise de premier plan.
          L'anticipation est au cœur de notre démarche, car nous visons à maintenir notre avance technologique pour répondre aux besoins futurs de nos clients.
        </p>
      </div>
...
<div className="themes-grid">
    ...
    <div className="theme">
        <img src={im3} alt="Sécurité des Aliments" className="theme-image"/>
        <p>Miel</p>
    </div>
    <div className="theme">
        <img src={im4} alt="Management de la Qualité" className="theme-image"/>
    ...
    <div className="theme">
        <img src={im6} alt="Bonnes Pratiques de Prélèvement" className="theme-image"/>
    ...
    <div className="theme">
        <img src={im8} alt="Bonnes Pratiques de Prélèvement" className="theme-image"/>
...
<section className="logistics-section">
        <div className="logistics-content">
          ...
          <p>
            <strong>MULTILAB s.a</strong> met en place une solution intégrée pour simplifier le processus d’acheminement des échantillons pour nos clients.
          </p>
          <p>
            Une équipe de techniciens-préleveurs dédiés, compétents et qualifiés, opère à travers tout le territoire pour collecter, échantillonner ou prélever les échantillons directement sur site, chaque jour.
          </p>
          <p>
            Équipés de véhicules respectant les normes en vigueur, nos techniciens-préleveurs contribuent à une réactivité optimale, une traçabilité renforcée et une parfaite maîtrise de la chaîne du froid.
          </p>
        </div>
