    ...
    <div className="assistance-container">
      ...
      <div className="containers desktop-only">
        <div className="text-left animation-class">
          ...
          <p>
            ...
            continue, tout en respectant les normes réglementaires et en alliant
            expertise et proximité. Notre mission est de vous fournir un
            accompagnement global, en analysant les résultats de vos analyses et
            de vos audits, en identifiant les causes des problèmes et en
            proposant des solutions efficaces pour optimiser vos plans d'action.
          </p>
        </div>
        <img
          src={assistanceImage}
      ...
      <div className="containers desktop-only">
        ...
        <div className="text-right animation-class">
          ...
          <p>
            <strong>MULTILAB s.a</strong> s’engage à vous fournir un service de
            qualité, en tenant compte de vos besoins spécifiques et en proposant
            des solutions sur mesure, telles que la validation de vos processus
            de fabrication et la vérification de la stabilité de vos produits
            dans le temps. Notre objectif est de garantir votre satisfaction par
            une écoute attentive, une grande réactivité et une expertise
            reconnue. Nous innovons constamment pour rester à la pointe des
            évolutions technologiques et réglementaires, tout en intégrant des
            pratiques respectueuses de l'environnement pour protéger notre
            planète.
          </p>
        </div>
      </div>
      ...
      <div className="containers desktop-only">
        <div className="text-left animation-class">
          ...
          <p>
            ...
            des normes sanitaires optimales et assurant la sécurité alimentaire.
            Nous intervenons dans divers secteurs, tels que l'industrie et la
            distribution alimentaires, la restauration et l'hôtellerie... Notre
            objectif est d'aider nos clients à maintenir des standards élevés en
            matière d'hygiène et de sécurité, tout en respectant les
            réglementations en vigueur et en intégrant les meilleures pratiques
      ...
      <div className="containers mobile-only">
        ...
        <img src={img3} className="image-right" alt="Image 3" />
        <div className="text-left">
          <p>
      ...
      <div className="containers mobile-only">
        ...
        <img src={img4} className="image-left" alt="Image 4" />
        <div className="text-right">
          <p>
            Nos équipes de Docteurs, ingénieurs et techniciens assurent un rôle
            de conseiller, et vous apportent leurs expertises et conseils pour
