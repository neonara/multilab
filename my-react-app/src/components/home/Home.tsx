...
<VideoSection></VideoSection>
      ...
      <div className="text-section">
        ...
        <p className='top-paragraph'>« Bien plus qu’un laboratoire agroalimentaire, un véritable partenaire. »</p>
  ...
  <div className="values-grid">
    ...
    <h2 className="home-title">Nos prestations</h2>
      ...
      Nous vous offrons une gamme complète de services sur-mesure pour répondre à tous vos besoins       </p>
    ...
    <div className="prestations-grid">
      ...
      <p className="home-description">
        Le laboratoire MULTILAB s.a développe une gamme d'analyses complète et diversifiée, utilisant des technologies modernes et des méthodes avancées pour répondre aux besoins variés de ses clients.
      </p>
      <AnalysesCard/>
          </div>
    ...
    <div style={{
      ...
      <div style={{  padding: '20px', borderRadius: '15px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap' }}>
        <div style={{ flex: '1 1 60%', padding: '10px' }}>
          <h3 style={{ color: '#003A79', fontSize: '24px', marginBottom: '10px' }}>Nos accréditations</h3>
          <p style={{ color: '#003A79', fontSize: '18px' }}>
            Depuis 2012, <strong>MULTILAB s.a</strong> est accrédité par le <strong>TUNAC</strong> en microbiologie alimentaire, microbiologie des eaux et physicochimie des aliments. Nous avons élargi notre champ d'accréditation, passant de 6 à 28 méthodes d'analyse.
          </p>
          <button style={{ alignContent:'left' ,backgroundColor: 'transparent', color: '#003A79', padding: '10px 20px', borderRadius: '5px', fontSize: '16px', marginTop: '20px', cursor: 'pointer' }}>En apprendre plus</button>
        </div>
        <div style={{ flex: '1 1 30%', textAlign: 'center', padding: '10px', height :'208px'}}>
          <img src={log} alt="TUNAC Accreditation" style={{ maxWidth: '100%', borderRadius: '10px',height:'225px' }} />
        </div>
      </div>
    </div>
    </div>
    <section className="projects-section">
        ...
        <p className="projects-subtitle">Soyez les premiers à connaître nos événements et formations à venir</p>
        ...
        <div className="projects-cards">
          ...
          <div className="project-image-wrapper">
            ...
            <div className="project-info">
              ...
              <a href="/link-to-project1" className="project-link">Lire la suite</a>
            </div>
          </div>
</div>
          <div className="project-card">
            ...
            <div className="project-info">
              ...
              <a href="/link-to-project2" className="project-link">Lire la suite</a>
            </div>
          </div>
          ...
          <div className="project-card">
            ...
            <div className="project-info">
              ...
              <a href="/link-to-project3" className="project-link">Lire la suite</a>
            </div>
          </div>
        </div>
      </section>
